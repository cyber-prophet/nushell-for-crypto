...
pussy keys list
pussy keys list --output json
pussy keys list --output json | from json
pussy keys list --output json | from json | get address
pussy keys list --output json | from json | get address.0
...
pussy query bank balances $key1 --node https://rpc.space-pussy.cybernode.ai:443 --output json | from json 
pussy query bank balances $key1 --node https://rpc.space-pussy.cybernode.ai:443 --output json | from json | get balances
pussy query bank balances $key1 --node https://rpc.space-pussy.cybernode.ai:443 --output json | from json | get balances.amount.0
let amount1 = (pussy query bank balances $key1 --node https://rpc.space-pussy.cybernode.ai:443 --output json | from json | get balances.amount.0)
...
pussy tx staking delegate -h
pussy tx staking delegate $validator1 $amount_pussy --from video-key 
pussy tx staking delegate $validator1 $amount_pussy --from video-key --node https://rpc.space-pussy.cybernode.ai:443
pussy tx staking delegate $validator1 $amount_pussy --from video-key --node https://rpc.space-pussy.cybernode.ai:443 --chain-id space-pussy
pussy query bank balances $key1 --node https://rpc.space-pussy.cybernode.ai:443 --output json
